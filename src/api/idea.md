1. API document docs swagger
2. Write test for all function
3. Log lỗi theo format chuẩn để dễ tracing và mornitoring
4. Tất cả message success, error,... cần được define chung, tránh message trực tiếp trong function
