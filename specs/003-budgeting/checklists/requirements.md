...
- Truy vết FR ↔ Acceptance: FR-001→US1#1/#3, FR-002→US4#1, FR-003→US1#2, FR-004→US1#1 + edge "Sang kỳ mới", FR-005/006→US2#1–#6, FR-007→US3#1, FR-008→US3#2, FR-009→US3#3/#4, FR-010→US1#4 + US4#2, FR-011→US1#5, FR-012→US5#1–#3, FR-013→US5#4.
